...
- `multiplayer/` — production `GameSimulation`, bounded GameNet payload codec, fixed first-release composition, deterministic spawn/collision ownership, network-session lifecycle, snapshot interpolation, and render-only remote vehicle fleets.
